...
Rails.application.configure do
  ...
  config.assets.compile = true # if you set to false it will use the static one which can be quicker.
  ...
  ### Send In Blue/Brevo Configuration
  config.action_mailer.smtp_settings = {
    address: ENV["SEND_IN_BLUE_EMAIL_SMTP_SERVER"],
    port: 587,
    domain: ENV["SEND_IN_BLUE_DOMAIN"],

        ...
        class Api < ApiBase
            class V2010 < Version
                ...
                class TranscriptionContext < InstanceContext
                    ...
                    # @param [String] recording_sid The SID of the [Recording](https://www.twilio.com/docs/voice/api/recording) that created the transcription to fetch.
                ...
                class TranscriptionPage < Page
                    ...
                    def get_instance(payload)
                        TranscriptionInstance.new(@version, payload, account_sid: @solution[:account_sid], recording_sid: @solution[:recording_sid])
                    end
                ...
                class TranscriptionInstance < InstanceResource
                    ...
                    def initialize(version, payload , account_sid: nil, recording_sid: nil, sid: nil)
                        ...
                        @params = { 'account_sid' => account_sid  ,'recording_sid' => recording_sid  || @properties['recording_sid']  ,'sid' => sid  || @properties['sid']  , }
                    end

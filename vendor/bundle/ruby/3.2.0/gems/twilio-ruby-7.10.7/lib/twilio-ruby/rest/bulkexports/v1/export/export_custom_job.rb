                ...
                class ExportContext < InstanceContext
                    ...
                    def create_with_metadata(
                      ...
                      email: :unset
                        ...
                        export_custom_job_instance = ExportCustomJobInstance.new(
                            @version,
                            response.body,
                            resource_type: @solution[:resource_type],
                        )
                ...
                class ExportCustomJobPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && records < limit )
                            @export_custom_job_page << ExportCustomJobListResponse.new(version, @payload, key, limit - records)

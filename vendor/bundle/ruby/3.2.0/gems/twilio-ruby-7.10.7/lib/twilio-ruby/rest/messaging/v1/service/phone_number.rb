        ...
        class Messaging < MessagingBase
            class V1 < Version
                class ServiceContext < InstanceContext
                    ...
                    # @param [String] phone_number_sid The SID of the Phone Number being added to the Service.
                ...
                class PhoneNumberInstance < InstanceResource
                    ...
                    ##
                    # @return [Array<String>] An array of values that describe whether the number can receive calls or messages. Can be: `Voice`, `SMS`, and `MMS`.
                    def capabilities

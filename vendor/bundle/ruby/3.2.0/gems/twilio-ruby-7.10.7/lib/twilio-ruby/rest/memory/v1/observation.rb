            ...
            class V1 < Version
                class ObservationList < ListResource
                    ...
                    class CreateObservationsRequest
                            # @param [observations]: [Array<ObservationList.ObservationCore>] Array of observations to create in a single batch operation.
                ...
                class ObservationContext < InstanceContext
                    ...
                    # @param [ObservationCore] observation_core 
                    ...
                    def patch(observation_core: nil
                        ...
                        payload = @version.patch('PATCH', @uri, headers: headers, data: observation_core.to_json)
                        ObservationInstance.new(
                            @version,
                            payload,
                            store_id: @solution[:store_id],
                    ...
                    def patch_with_metadata(observation_core: nil
                    )
                        ...
                        response = @version.patch_with_metadata('PATCH', @uri, headers: headers, data: observation_core.to_json)
                        observation_instance = ObservationInstance.new(
                            @version,
                            response.body,
                            store_id: @solution[:store_id],

            ...
            class V2 < Version
                ...
                class UserBindingContext < InstanceContext
                    ...
                    def fetch_with_metadata
                        ...
                        user_binding_instance = UserBindingInstance.new(
                            @version,
                            response.body,
                            service_sid: @solution[:service_sid],
                            user_sid: @solution[:user_sid],
                ...
                class UserBindingPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && records < limit )
                            @user_binding_page << UserBindingListResponse.new(version, @payload, key, limit - records)
                ...
                class UserBindingListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @user_binding = data_list.map do |data|
                        UserBindingInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

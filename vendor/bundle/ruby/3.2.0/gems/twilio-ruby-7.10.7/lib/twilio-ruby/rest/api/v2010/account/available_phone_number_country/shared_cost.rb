            ...
            class V2010 < Version
                ...
                class SharedCostPage < Page
                    ...
                    def get_instance(payload)
                        SharedCostInstance.new(@version, payload, account_sid: @solution[:account_sid], country_code: @solution[:country_code])
                    end
                ...
                class SharedCostPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && records < limit )
                            @shared_cost_page << SharedCostListResponse.new(version, @payload, key, limit - records)
                ...
                class SharedCostInstance < InstanceResource
                    ...
                    #   {Account}[https://www.twilio.com/docs/iam/api/account] that created this SharedCost
                    #   resource.

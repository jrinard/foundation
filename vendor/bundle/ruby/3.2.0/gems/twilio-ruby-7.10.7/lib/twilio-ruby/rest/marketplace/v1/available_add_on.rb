            ...
            class V1 < Version
                ...
                class AvailableAddOnContext < InstanceContext
                    ...
                    def fetch_with_metadata
                        ...
                        available_add_on_instance = AvailableAddOnInstance.new(
                            @version,
                            response.body,
                            sid: @solution[:sid],
                        )
                ...
                class AvailableAddOnPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && records < limit )
                            @available_add_on_page << AvailableAddOnListResponse.new(version, @payload, key, limit - records)
                ...
                class AvailableAddOnListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @available_add_on = data_list.map do |data|
                        AvailableAddOnInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

        ...
        class Knowledge < KnowledgeBase
            class V2 < Version
                class OperationList < ListResource
                    ...
                    def to_s
                        '#<Twilio.Knowledge.V2.OperationList>'
                    end
                end
                ...
                class OperationContext < InstanceContext
                    ...
                    def initialize(version, operation_id)
                        ...
                        @uri = "/ControlPlane/Operations/#{@solution[:operation_id]}"
                    ...
                    def to_s
                        ...
                        "#<Twilio.Knowledge.V2.OperationContext #{context}>"
                    end
                ...
                class OperationPage < TokenPage
                    ...
                    # Provide a user friendly representation
                    def to_s
                        '<Twilio.Knowledge.V2.OperationPage>'
                    end
                end
                ...
                class OperationInstance < InstanceResource
                    ...
                    ##
                    # @return [String] The unique identifier for this operation.
                    def operation_id
                    ...
                    ##
                    # @return [Time] When the operation was created.
                    def created_at
                    ...
                    ##
                    # @return [Time] When the operation completed or failed.
                    def completed_at
                        @properties['completed_at']
                    end
                    
                    ##
                    # @return [OperationResultResourceId] 
                    def result
                        @properties['result']
                    end
                    ...
                    ##
                    # @return [String] URL to fetch the resulting resource.
                    def result_url

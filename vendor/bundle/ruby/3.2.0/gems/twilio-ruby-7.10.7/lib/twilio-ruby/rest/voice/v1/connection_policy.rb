        ...
        class Voice < VoiceBase
            class V1 < Version
                ...
                class ConnectionPolicyInstance < InstanceResource
                    ...
                    #   {Account}[https://www.twilio.com/docs/iam/api/account] that created this ConnectionPolicy
                    #   resource.
                    ...
                    # @return [ConnectionPolicyContext] CallContext for this CallInstance
                    def context
                    ...
                    ##
                    # @return [String] The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Connection Policy resource.
                    def account_sid
                        @properties['account_sid']
                    end
                    
                    ##
                    # @return [String] The unique string that we created to identify the Connection Policy resource.
                    def sid
                        @properties['sid']
                    end

        ...
        class Events < EventsBase
            class V1 < Version
                class EventTypeList < ListResource
                    ...
                    ##
                    # Lists EventTypePageMetadata records from the API as a list.
                      # @param [String] schema_id A string parameter filtering the results to return only the Event Types using a given schema.
                    # @param [Integer] limit Upper limit for the number of records to return. stream()
                    #    guarantees to never return more than limit.  Default is no limit
                    # @param [Integer] page_size Number of records to fetch per request, when
                    ...
                    #    efficient page size, i.e. min(limit, 1000)
                    # @return [Array] Array of up to limit results
                    def list_with_metadata(schema_id: :unset, limit: nil, page_size: nil)
                        limits = @version.read_limits(limit, page_size)
                        ...
                        EventTypePageMetadata.new(@version, response, @solution, limits[:limit])
                    end
                ...
                class EventTypeContext < InstanceContext
                    ...
                    def fetch_with_metadata
                        ...
                        event_type_instance = EventTypeInstance.new(
                            @version,
                            response.body,
                            type: @solution[:type],
                        )
                        EventTypeInstanceMetadata.new(
                            @version,
                            event_type_instance,
                            response.headers,
                ...
                class EventTypeInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new EventTypeInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}EventTypeInstance] event_type_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [EventTypeInstanceMetadata] The initialized instance with metadata.
                ...
                class EventTypeListResponse < InstanceListResource
                    # @param [Array<EventTypeInstance>] instance
                    # @param [Hash{String => Object}] headers
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                       @event_type_instance = payload.body[key].map do |data|
                        EventTypeInstance.new(version, data)
                       end
                       @headers = payload.headers
                       @status_code = payload.status_code
                    end

                      def event_type_instance
                          @instance
                      end
                  end
                ...
                class EventTypePageMetadata < PageMetadata
                    attr_reader :event_type_page
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && records < limit )
                            @event_type_page << EventTypeListResponse.new(version, @payload, key, limit - records)
                    ...
                    def each
                        @event_type_page.each do |record|
                          yield record
                        end
                    end
                ...
                class EventTypeListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @event_type = data_list.map do |data|
                        EventTypeInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

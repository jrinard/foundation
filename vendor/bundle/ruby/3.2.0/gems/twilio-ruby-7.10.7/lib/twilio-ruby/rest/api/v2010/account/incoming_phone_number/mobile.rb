        ...
        class Api < ApiBase
            class V2010 < Version
                ...
                class IncomingPhoneNumberList < ListResource
                    ...
                    # @param [String] friendly_name A descriptive string that you created to describe the new phone number. It can be up to 64 characters long. By default, the is a formatted version of the phone number.
                    # @param [String] sms_application_sid The SID of the application that should handle SMS messages sent to the new phone number. If an `sms_application_sid` is present, we ignore all of the `sms_*_url` urls and use those of the application.
                    ...
                    ##
                    # Create the MobileInstanceMetadata
                    # @param [String] phone_number The phone number to purchase specified in [E.164](https://www.twilio.com/docs/glossary/what-e164) format.  E.164 phone numbers consist of a + followed by the country code and subscriber number without punctuation characters. For example, +14155551234.
                    # @param [String] api_version The API version to use for incoming calls made to the new phone number. The default is `2010-04-01`.
                    # @param [String] friendly_name A descriptive string that you created to describe the new phone number. It can be up to 64 characters long. By default, the is a formatted version of the phone number.
                    # @param [String] sms_application_sid The SID of the application that should handle SMS messages sent to the new phone number. If an `sms_application_sid` is present, we ignore all of the `sms_*_url` urls and use those of the application.
                    ...
                    def create_with_metadata(
                      ...
                      bundle_sid: :unset
                        ...
                        mobile_instance = MobileInstance.new(
                            @version,
                            response.body,
                            account_sid: @solution[:account_sid],
                        )
                        MobileInstanceMetadata.new(
                            @version,
                            mobile_instance,
                            response.headers,
                    ...
                    ##
                    # Lists MobilePageMetadata records from the API as a list.
                      # @param [Boolean] beta Whether to include phone numbers new to the Twilio platform. Can be: `true` or `false` and the default is `true`.
                      # @param [String] friendly_name A string that identifies the resources to read.
                      # @param [String] phone_number The phone numbers of the IncomingPhoneNumber resources to read. You can specify partial numbers and use '*' as a wildcard for any digit.
                      # @param [String] origin Whether to include phone numbers based on their origin. Can be: `twilio` or `hosted`. By default, phone numbers of all origin are included.
                    ...
                    def list_with_metadata(beta: :unset, friendly_name: :unset, phone_number: :unset, origin: :unset, limit: nil, page_size: nil)
                        ...
                        MobilePageMetadata.new(@version, response, @solution, limits[:limit])
                    end
                ...
                class MobilePageMetadata < PageMetadata
                    attr_reader :mobile_page
                ...
                class MobileListResponse < InstanceListResource

                    # @param [Array<MobileInstance>] instance
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @mobile = data_list.map do |data|
                        MobileInstance.new(version, data)
                      end
                ...
                class MobileInstance < InstanceResource
                    ...
                    #   {Account}[https://www.twilio.com/docs/iam/api/account] that created this Mobile
                    #   resource.

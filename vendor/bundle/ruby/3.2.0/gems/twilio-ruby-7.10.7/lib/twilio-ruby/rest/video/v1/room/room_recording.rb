            ...
            class V1 < Version
                ...
                class RoomRecordingContext < InstanceContext
                    ...
                    def fetch_with_metadata
                        ...
                        room_recording_instance = RoomRecordingInstance.new(
                            @version,
                            response.body,
                            room_sid: @solution[:room_sid],
                            sid: @solution[:sid],
                ...
                class RoomRecordingPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && records < limit )
                            @room_recording_page << RoomRecordingListResponse.new(version, @payload, key, limit - records)
                ...
                class RoomRecordingListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @room_recording = data_list.map do |data|
                        RoomRecordingInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

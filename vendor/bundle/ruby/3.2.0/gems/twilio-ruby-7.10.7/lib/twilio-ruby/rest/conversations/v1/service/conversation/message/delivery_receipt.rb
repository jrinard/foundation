        ...
        class Conversations < ConversationsBase
            class V1 < Version
                ...
                class MessageContext < InstanceContext
                    ...
                    ##
                    # Lists DeliveryReceiptPageMetadata records from the API as a list.
                    # @param [Integer] limit Upper limit for the number of records to return. stream()
                    #    guarantees to never return more than limit.  Default is no limit
                    # @param [Integer] page_size Number of records to fetch per request, when
                    #    not set will use the default value of 50 records.  If no page_size is defined
                    ...
                    def list_with_metadata(limit: nil, page_size: nil)
                        ...
                        DeliveryReceiptPageMetadata.new(@version, response, @solution, limits[:limit])
                    end
                ...
                class DeliveryReceiptContext < InstanceContext
                    ...
                    ##
                    # Fetch the DeliveryReceiptInstanceMetadata
                    # @return [DeliveryReceiptInstance] Fetched DeliveryReceiptInstance
                    def fetch_with_metadata
                        ...
                        delivery_receipt_instance = DeliveryReceiptInstance.new(
                            @version,
                            response.body,
                            chat_service_sid: @solution[:chat_service_sid],
                            conversation_sid: @solution[:conversation_sid],
                        ...
                        DeliveryReceiptInstanceMetadata.new(
                            @version,
                            delivery_receipt_instance,
                            response.headers,
                ...
                class DeliveryReceiptInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new DeliveryReceiptInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}DeliveryReceiptInstance] delivery_receipt_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [DeliveryReceiptInstanceMetadata] The initialized instance with metadata.
                    def initialize(version, delivery_receipt_instance, headers, status_code)
                        super(version, headers, status_code)
                        @delivery_receipt_instance = delivery_receipt_instance
                    end
                    ...
                    def to_s
                      "<Twilio.Api.V2010.DeliveryReceiptInstanceMetadata status=#{@status_code}>"
                    end
                end

                class DeliveryReceiptListResponse < InstanceListResource
                    # @param [Array<DeliveryReceiptInstance>] instance
                    # @param [Hash{String => Object}] headers
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                       @delivery_receipt_instance = payload.body[key].map do |data|
                        DeliveryReceiptInstance.new(version, data)
                       end
                       @headers = payload.headers
                       @status_code = payload.status_code
                    end

                      def delivery_receipt_instance
                          @instance
                      end
                  end
                ...
                class DeliveryReceiptPageMetadata < PageMetadata
                    attr_reader :delivery_receipt_page

                    def initialize(version, response, solution, limit)
                        super(version, response)
                        @delivery_receipt_page = []
                        @limit = limit
                        key = get_key(response.body)
                        records = 0
                        while( limit != :unset && records < limit )
                            @delivery_receipt_page << DeliveryReceiptListResponse.new(version, @payload, key, limit - records)
                    ...
                    def each
                        @delivery_receipt_page.each do |record|
                          yield record
                        end
                    end
                ...
                class DeliveryReceiptListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @delivery_receipt = data_list.map do |data|
                        DeliveryReceiptInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

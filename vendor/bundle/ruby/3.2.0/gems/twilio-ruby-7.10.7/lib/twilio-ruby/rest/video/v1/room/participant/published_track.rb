            ...
            class V1 < Version
                ...
                class PublishedTrackContext < InstanceContext
                    ...
                    def fetch_with_metadata
                        ...
                        published_track_instance = PublishedTrackInstance.new(
                            @version,
                            response.body,
                            room_sid: @solution[:room_sid],
                            participant_sid: @solution[:participant_sid],
                ...
                class PublishedTrackPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && records < limit )
                            @published_track_page << PublishedTrackListResponse.new(version, @payload, key, limit - records)
                ...
                class PublishedTrackListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @published_track = data_list.map do |data|
                        PublishedTrackInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

        ...
        class Taskrouter < TaskrouterBase
            class V1 < Version
                ...
                class WorkspaceCumulativeStatisticsContext < InstanceContext
                    ...
                    ##
                    # Fetch the WorkspaceCumulativeStatisticsInstanceMetadata
                    # @param [Time] end_date Only include usage that occurred on or before this date, specified in GMT as an [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date-time.
                    # @param [String] minutes Only calculate statistics since this many minutes in the past. The default 15 minutes. This is helpful for displaying statistics for the last 15 minutes, 240 minutes (4 hours), and 480 minutes (8 hours) to see trends.
                    # @param [Time] start_date Only calculate statistics from this date and time and later, specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
                    # @param [String] task_channel Only calculate cumulative statistics on this TaskChannel. Can be the TaskChannel's SID or its `unique_name`, such as `voice`, `sms`, or `default`.
                    ...
                    def fetch_with_metadata(
                      ...
                      split_by_wait_time: :unset
                        ...
                        workspace_cumulative_statistics_instance = WorkspaceCumulativeStatisticsInstance.new(
                            @version,
                            response.body,
                            workspace_sid: @solution[:workspace_sid],
                        )
                        WorkspaceCumulativeStatisticsInstanceMetadata.new(
                            @version,
                            workspace_cumulative_statistics_instance,
                            response.headers,
                ...
                class WorkspaceCumulativeStatisticsInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new WorkspaceCumulativeStatisticsInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}WorkspaceCumulativeStatisticsInstance] workspace_cumulative_statistics_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [WorkspaceCumulativeStatisticsInstanceMetadata] The initialized instance with metadata.
                    def initialize(version, workspace_cumulative_statistics_instance, headers, status_code)
                        super(version, headers, status_code)
                        @workspace_cumulative_statistics_instance = workspace_cumulative_statistics_instance
                    end
                    ...
                    def to_s
                      "<Twilio.Api.V2010.WorkspaceCumulativeStatisticsInstanceMetadata status=#{@status_code}>"
                    end
                end
                ...
                class WorkspaceCumulativeStatisticsListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key)
                       @workspace_cumulative_statistics_instance = payload.body[key].map do |data|
                      ...
                      def workspace_cumulative_statistics_instance
                          @instance
                      end
                  end

        ...
        class Studio < StudioBase
            class V2 < Version
                class FlowContext < InstanceContext
                    ...
                    ##
                    # Lists FlowRevisionPageMetadata records from the API as a list.
                    # @param [Integer] limit Upper limit for the number of records to return. stream()
                    #    guarantees to never return more than limit.  Default is no limit
                    # @param [Integer] page_size Number of records to fetch per request, when
                    #    not set will use the default value of 50 records.  If no page_size is defined
                    ...
                    def list_with_metadata(limit: nil, page_size: nil)
                        ...
                        FlowRevisionPageMetadata.new(@version, response, @solution, limits[:limit])
                    end
                ...
                class FlowRevisionContext < InstanceContext
                    ...
                    ##
                    # Fetch the FlowRevisionInstanceMetadata
                    # @return [FlowRevisionInstance] Fetched FlowRevisionInstance
                    def fetch_with_metadata
                        ...
                        flow_revision_instance = FlowRevisionInstance.new(
                            @version,
                            response.body,
                            sid: @solution[:sid],
                            revision: @solution[:revision],
                        )
                        FlowRevisionInstanceMetadata.new(
                            @version,
                ...
                class FlowRevisionInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new FlowRevisionInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}FlowRevisionInstance] flow_revision_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [FlowRevisionInstanceMetadata] The initialized instance with metadata.
                    def initialize(version, flow_revision_instance, headers, status_code)
                        super(version, headers, status_code)
                        @flow_revision_instance = flow_revision_instance
                    end
                    ...
                    def to_s
                      "<Twilio.Api.V2010.FlowRevisionInstanceMetadata status=#{@status_code}>"
                    end
                end

                class FlowRevisionListResponse < InstanceListResource
                    # @param [Array<FlowRevisionInstance>] instance
                    # @param [Hash{String => Object}] headers
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                       @flow_revision_instance = payload.body[key].map do |data|
                        FlowRevisionInstance.new(version, data)
                       end
                       @headers = payload.headers
                       @status_code = payload.status_code
                    end

                      def flow_revision_instance
                          @instance
                      end
                  end
                ...
                class FlowRevisionPageMetadata < PageMetadata
                    attr_reader :flow_revision_page
                    ...
                    def each
                        @flow_revision_page.each do |record|
                          yield record
                        end
                    end
                ...
                class FlowRevisionListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @flow_revision = data_list.map do |data|
                        FlowRevisionInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

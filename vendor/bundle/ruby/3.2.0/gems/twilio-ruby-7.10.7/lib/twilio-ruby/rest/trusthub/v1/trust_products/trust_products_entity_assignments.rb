        ...
        class Trusthub < TrusthubBase
            class V1 < Version
                class TrustProductsContext < InstanceContext
                    ...
                    ##
                    # Create the TrustProductsEntityAssignmentsInstanceMetadata
                    # @param [String] object_sid The SID of an object bag that holds information of the different items.
                    # @return [TrustProductsEntityAssignmentsInstance] Created TrustProductsEntityAssignmentsInstance
                    def create_with_metadata(
                      object_sid: nil
                        ...
                        trust_products_entity_assignments_instance = TrustProductsEntityAssignmentsInstance.new(
                            @version,
                            response.body,
                            trust_product_sid: @solution[:trust_product_sid],
                        )
                        TrustProductsEntityAssignmentsInstanceMetadata.new(
                            @version,
                    ...
                    ##
                    # Lists TrustProductsEntityAssignmentsPageMetadata records from the API as a list.
                      # @param [String] object_type A string to filter the results by (EndUserType or SupportingDocumentType) machine-name. This is useful when you want to retrieve the entity-assignment of a specific end-user or supporting document.
                    # @param [Integer] limit Upper limit for the number of records to return. stream()
                    #    guarantees to never return more than limit.  Default is no limit
                    # @param [Integer] page_size Number of records to fetch per request, when
                    ...
                    def list_with_metadata(object_type: :unset, limit: nil, page_size: nil)
                        ...
                        TrustProductsEntityAssignmentsPageMetadata.new(@version, response, @solution, limits[:limit])
                    end
                ...
                class TrustProductsEntityAssignmentsContext < InstanceContext
                    ...
                    def delete_with_metadata
                        ...
                        headers = Twilio::Values.of({'Content-Type' => 'application/x-www-form-urlencoded', })
                          ...
                          trustProductsEntityAssignments_instance = TrustProductsEntityAssignmentsInstance.new(
                              @version,
                              response.body,
                              account_sid: @solution[:account_sid],
                              sid: @solution[:sid],
                          )
                          TrustProductsEntityAssignmentsInstanceMetadata.new(@version, trustProductsEntityAssignments_instance, response.headers, response.status_code)
                    end
                ...
                class TrustProductsEntityAssignmentsInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new TrustProductsEntityAssignmentsInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}TrustProductsEntityAssignmentsInstance] trust_products_entity_assignments_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [TrustProductsEntityAssignmentsInstanceMetadata] The initialized instance with metadata.
                    def initialize(version, trust_products_entity_assignments_instance, headers, status_code)
                        super(version, headers, status_code)
                        @trust_products_entity_assignments_instance = trust_products_entity_assignments_instance
                    end
                    ...
                    def to_s
                      "<Twilio.Api.V2010.TrustProductsEntityAssignmentsInstanceMetadata status=#{@status_code}>"
                    end
                end

                class TrustProductsEntityAssignmentsListResponse < InstanceListResource
                    # @param [Array<TrustProductsEntityAssignmentsInstance>] instance
                    # @param [Hash{String => Object}] headers
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                       @trust_products_entity_assignments_instance = payload.body[key].map do |data|
                        TrustProductsEntityAssignmentsInstance.new(version, data)
                       end
                       @headers = payload.headers
                       @status_code = payload.status_code
                    end

                      def trust_products_entity_assignments_instance
                          @instance
                      end
                  end
                ...
                class TrustProductsEntityAssignmentsPageMetadata < PageMetadata
                    attr_reader :trust_products_entity_assignments_page

                    def initialize(version, response, solution, limit)
                        super(version, response)
                        @trust_products_entity_assignments_page = []
                        @limit = limit
                        key = get_key(response.body)
                        records = 0
                        while( limit != :unset && records < limit )
                            @trust_products_entity_assignments_page << TrustProductsEntityAssignmentsListResponse.new(version, @payload, key, limit - records)
                    ...
                    def each
                        @trust_products_entity_assignments_page.each do |record|
                          yield record
                        end
                    end
                ...
                class TrustProductsEntityAssignmentsListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @trust_products_entity_assignments = data_list.map do |data|
                        TrustProductsEntityAssignmentsInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

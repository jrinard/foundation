            ...
            class V1 < Version
                ...
                class TaskQueueCumulativeStatisticsPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && records < limit )
                            @task_queue_cumulative_statistics_page << TaskQueueCumulativeStatisticsListResponse.new(version, @payload, key, limit - records)
                ...
                class TaskQueueCumulativeStatisticsListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @task_queue_cumulative_statistics = data_list.map do |data|
                        TaskQueueCumulativeStatisticsInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

        ...
        class Knowledge < KnowledgeBase
            class V1 < Version
                class KnowledgeList < ListResource
                    ...
                    # @param [KnowledgeV1ServiceCreateKnowledgeRequest] knowledge_v1_service_create_knowledge_request 
                    # @return [KnowledgeInstance] Created KnowledgeInstance
                    def create_with_metadata(knowledge_v1_service_create_knowledge_request: nil
                    )
                        ...
                        response = @version.create_with_metadata('POST', @uri, headers: headers, data: knowledge_v1_service_create_knowledge_request.to_json)
                    ...
                    #    efficient page size, i.e. min(limit, 1000)
                    # @return [Array] Array of up to limit results
                    def list_with_metadata(tags: :unset, limit: nil, page_size: nil)
                        limits = @version.read_limits(limit, page_size)
                ...
                class KnowledgeContext < InstanceContext
                    ...
                    # @param [KnowledgeV1ServiceUpdateKnowledgeRequest] knowledge_v1_service_update_knowledge_request 
                    # @return [KnowledgeInstance] Updated KnowledgeInstance
                    def update_with_metadata(knowledge_v1_service_update_knowledge_request: :unset
                    )
                        ...
                        response = @version.update_with_metadata('PUT', @uri, headers: headers, data: knowledge_v1_service_update_knowledge_request.to_json)
                        knowledge_instance = KnowledgeInstance.new(
                            @version,
                            response.body,
                            id: @solution[:id],

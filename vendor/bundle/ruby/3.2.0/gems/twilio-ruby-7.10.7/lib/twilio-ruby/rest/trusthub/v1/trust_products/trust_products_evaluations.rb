        ...
        class Trusthub < TrusthubBase
            class V1 < Version
                class TrustProductsContext < InstanceContext
                    ...
                    ##
                    # Create the TrustProductsEvaluationsInstanceMetadata
                    # @param [String] policy_sid The unique string of a policy that is associated to the customer_profile resource.
                    # @return [TrustProductsEvaluationsInstance] Created TrustProductsEvaluationsInstance
                    def create_with_metadata(
                      policy_sid: nil
                        ...
                        trust_products_evaluations_instance = TrustProductsEvaluationsInstance.new(
                            @version,
                            response.body,
                            trust_product_sid: @solution[:trust_product_sid],
                        )
                        TrustProductsEvaluationsInstanceMetadata.new(
                            @version,
                            trust_products_evaluations_instance,
                            response.headers,
                    ...
                    ##
                    # Lists TrustProductsEvaluationsPageMetadata records from the API as a list.
                    # @param [Integer] limit Upper limit for the number of records to return. stream()
                    #    guarantees to never return more than limit.  Default is no limit
                    # @param [Integer] page_size Number of records to fetch per request, when
                    #    not set will use the default value of 50 records.  If no page_size is defined
                    ...
                    def list_with_metadata(limit: nil, page_size: nil)
                        ...
                        TrustProductsEvaluationsPageMetadata.new(@version, response, @solution, limits[:limit])
                    end
                ...
                class TrustProductsEvaluationsInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new TrustProductsEvaluationsInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}TrustProductsEvaluationsInstance] trust_products_evaluations_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [TrustProductsEvaluationsInstanceMetadata] The initialized instance with metadata.
                    def initialize(version, trust_products_evaluations_instance, headers, status_code)
                        super(version, headers, status_code)
                        @trust_products_evaluations_instance = trust_products_evaluations_instance
                    end
                    ...
                    def to_s
                      "<Twilio.Api.V2010.TrustProductsEvaluationsInstanceMetadata status=#{@status_code}>"
                    end
                end

                class TrustProductsEvaluationsListResponse < InstanceListResource
                    # @param [Array<TrustProductsEvaluationsInstance>] instance
                    # @param [Hash{String => Object}] headers
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                       @trust_products_evaluations_instance = payload.body[key].map do |data|
                        TrustProductsEvaluationsInstance.new(version, data)
                       end
                       @headers = payload.headers
                       @status_code = payload.status_code
                    end

                      def trust_products_evaluations_instance
                          @instance
                      end
                  end
                ...
                class TrustProductsEvaluationsPageMetadata < PageMetadata
                    attr_reader :trust_products_evaluations_page
                ...
                class TrustProductsEvaluationsListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @trust_products_evaluations = data_list.map do |data|
                        TrustProductsEvaluationsInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

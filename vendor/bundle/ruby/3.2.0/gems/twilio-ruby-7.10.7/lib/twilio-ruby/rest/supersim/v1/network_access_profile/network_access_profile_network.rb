    ...
    module REST
        class Supersim < SupersimBase
            class V1 < Version
                class NetworkAccessProfileContext < InstanceContext
                    ...
                    def create_with_metadata(
                      network: nil
                        ...
                        NetworkAccessProfileNetworkInstanceMetadata.new(
                            @version,
                    ...
                    def list_with_metadata(limit: nil, page_size: nil)
                        ...
                        NetworkAccessProfileNetworkPageMetadata.new(@version, response, @solution, limits[:limit])
                    end
                ...
                class NetworkAccessProfileNetworkContext < InstanceContext
                    ...
                    def delete_with_metadata
                        ...
                        headers = Twilio::Values.of({'Content-Type' => 'application/x-www-form-urlencoded', })
                          ...
                          NetworkAccessProfileNetworkInstanceMetadata.new(@version, networkAccessProfileNetwork_instance, response.headers, response.status_code)
                    end
                ...
                class NetworkAccessProfileNetworkInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new NetworkAccessProfileNetworkInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}NetworkAccessProfileNetworkInstance] network_access_profile_network_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [NetworkAccessProfileNetworkInstanceMetadata] The initialized instance with metadata.
                ...
                class NetworkAccessProfileNetworkListResponse < InstanceListResource
                    # @param [Array<NetworkAccessProfileNetworkInstance>] instance
                ...
                class NetworkAccessProfileNetworkPageMetadata < PageMetadata
                    attr_reader :network_access_profile_network_page
                ...
                class NetworkAccessProfileNetworkListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @network_access_profile_network = data_list.map do |data|
                        NetworkAccessProfileNetworkInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

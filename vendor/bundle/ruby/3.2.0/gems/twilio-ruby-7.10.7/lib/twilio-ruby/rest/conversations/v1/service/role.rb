        ...
        class Conversations < ConversationsBase
            class V1 < Version
                ...
                class RoleContext < InstanceContext
                    ...
                    # @param [Version] version Version that contains the resource
                    # @param [String] chat_service_sid The SID of the [Conversation Service](https://www.twilio.com/docs/conversations/api/service-resource) to update the Role resource in.

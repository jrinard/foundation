            ...
            class V1 < Version
                ...
                class FunctionVersionContext < InstanceContext
                    ...
                    def fetch_with_metadata
                        ...
                        function_version_instance = FunctionVersionInstance.new(
                            @version,
                            response.body,
                            service_sid: @solution[:service_sid],
                            function_sid: @solution[:function_sid],
                ...
                class FunctionVersionPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && records < limit )
                            @function_version_page << FunctionVersionListResponse.new(version, @payload, key, limit - records)
                ...
                class FunctionVersionListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @function_version = data_list.map do |data|
                        FunctionVersionInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

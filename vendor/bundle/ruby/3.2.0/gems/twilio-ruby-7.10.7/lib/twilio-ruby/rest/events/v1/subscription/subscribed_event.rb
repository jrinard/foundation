        ...
        class Events < EventsBase
            class V1 < Version
                class SubscriptionContext < InstanceContext
                    ...
                    ##
                    # Create the SubscribedEventInstanceMetadata
                    # @param [String] type Type of event being subscribed to.
                    # @param [String] schema_version The schema version that the Subscription should use.
                    # @return [SubscribedEventInstance] Created SubscribedEventInstance
                    def create_with_metadata(
                      ...
                      schema_version: :unset
                        ...
                        SubscribedEventInstanceMetadata.new(
                            @version,
                    ...
                    ##
                    # Lists SubscribedEventPageMetadata records from the API as a list.
                    # @param [Integer] limit Upper limit for the number of records to return. stream()
                    #    guarantees to never return more than limit.  Default is no limit
                    # @param [Integer] page_size Number of records to fetch per request, when
                    #    not set will use the default value of 50 records.  If no page_size is defined
                    ...
                    def list_with_metadata(limit: nil, page_size: nil)
                        ...
                        SubscribedEventPageMetadata.new(@version, response, @solution, limits[:limit])
                    end
                ...
                class SubscribedEventContext < InstanceContext
                    ...
                    def delete_with_metadata
                        ...
                        headers = Twilio::Values.of({'Content-Type' => 'application/x-www-form-urlencoded', })
                          ...
                          SubscribedEventInstanceMetadata.new(@version, subscribedEvent_instance, response.headers, response.status_code)
                    end
                ...
                class SubscribedEventInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new SubscribedEventInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}SubscribedEventInstance] subscribed_event_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [SubscribedEventInstanceMetadata] The initialized instance with metadata.
                    def initialize(version, subscribed_event_instance, headers, status_code)
                        super(version, headers, status_code)
                        @subscribed_event_instance = subscribed_event_instance
                    end
                    ...
                    def to_s
                      "<Twilio.Api.V2010.SubscribedEventInstanceMetadata status=#{@status_code}>"
                    end
                end

                class SubscribedEventListResponse < InstanceListResource
                    # @param [Array<SubscribedEventInstance>] instance
                    # @param [Hash{String => Object}] headers
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                       @subscribed_event_instance = payload.body[key].map do |data|
                        SubscribedEventInstance.new(version, data)
                       end
                       @headers = payload.headers
                       @status_code = payload.status_code
                    end

                      def subscribed_event_instance
                          @instance
                      end
                  end
                ...
                class SubscribedEventPageMetadata < PageMetadata
                    attr_reader :subscribed_event_page
                ...
                class SubscribedEventListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @subscribed_event = data_list.map do |data|
                        SubscribedEventInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

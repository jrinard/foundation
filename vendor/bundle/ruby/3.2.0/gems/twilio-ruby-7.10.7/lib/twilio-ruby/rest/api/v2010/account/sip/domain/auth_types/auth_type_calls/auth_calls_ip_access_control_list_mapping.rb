            ...
            class V2010 < Version
                ...
                class AuthTypeCallsList < ListResource
                    ...
                    def create_with_metadata(
                      ip_access_control_list_sid: nil
                        ...
                        auth_calls_ip_access_control_list_mapping_instance = AuthCallsIpAccessControlListMappingInstance.new(
                            @version,
                            response.body,
                            account_sid: @solution[:account_sid],
                            domain_sid: @solution[:domain_sid],
                ...
                class AuthCallsIpAccessControlListMappingPageMetadata < PageMetadata
                    ...
                    def initialize(version, response, solution, limit)
                        ...
                        while( limit != :unset && records < limit )
                            @auth_calls_ip_access_control_list_mapping_page << AuthCallsIpAccessControlListMappingListResponse.new(version, @payload, key, limit - records)
                ...
                class AuthCallsIpAccessControlListMappingListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @auth_calls_ip_access_control_list_mapping = data_list.map do |data|
                        AuthCallsIpAccessControlListMappingInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

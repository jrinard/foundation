        ...
        class Conversations < ConversationsBase
            class V1 < Version
                ...
                class MessageContext < InstanceContext
                    ...
                    # @param [Version] version Version that contains the resource
                    # @param [String] chat_service_sid The SID of the [Conversation Service](https://www.twilio.com/docs/conversations/api/service-resource) the Participant resource is associated with.
                ...
                class MessagePage < Page
                    ...
                    def get_instance(payload)
                        MessageInstance.new(@version, payload, chat_service_sid: @solution[:chat_service_sid], conversation_sid: @solution[:conversation_sid])
                    end
                ...
                class MessageInstance < InstanceResource
                    ...
                    ##
                    # @return [String] The index of the message within the [Conversation](https://www.twilio.com/docs/conversations/api/conversation-resource).
                    def index
                        @properties['index']
                    end
                    ...
                    ##
                    # @return [String] An absolute API resource URL for this message.
                    def url
                        @properties['url']
                    end

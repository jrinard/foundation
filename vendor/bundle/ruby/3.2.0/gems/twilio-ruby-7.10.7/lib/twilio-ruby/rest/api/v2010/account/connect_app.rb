        ...
        class Api < ApiBase
            class V2010 < Version
                class AccountContext < InstanceContext
                    ...
                    ##
                    # Lists ConnectAppPageMetadata records from the API as a list.
                    # @param [Integer] limit Upper limit for the number of records to return. stream()
                    #    guarantees to never return more than limit.  Default is no limit
                    # @param [Integer] page_size Number of records to fetch per request, when
                    #    not set will use the default value of 50 records.  If no page_size is defined
                    ...
                    def list_with_metadata(limit: nil, page_size: nil)
                        ...
                        ConnectAppPageMetadata.new(@version, response, @solution, limits[:limit])
                    end
                ...
                class ConnectAppContext < InstanceContext
                    ...
                    def delete_with_metadata
                        ...
                        headers = Twilio::Values.of({'Content-Type' => 'application/x-www-form-urlencoded', })
                          ...
                          ConnectAppInstanceMetadata.new(@version, connectApp_instance, response.headers, response.status_code)
                    end
                    ...
                    def fetch_with_metadata
                        ...
                        ConnectAppInstanceMetadata.new(
                            @version,
                ...
                class ConnectAppInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new ConnectAppInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}ConnectAppInstance] connect_app_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [ConnectAppInstanceMetadata] The initialized instance with metadata.
                    def initialize(version, connect_app_instance, headers, status_code)
                        super(version, headers, status_code)
                        @connect_app_instance = connect_app_instance
                    end
                    ...
                    def to_s
                      "<Twilio.Api.V2010.ConnectAppInstanceMetadata status=#{@status_code}>"
                    end
                end

                class ConnectAppListResponse < InstanceListResource
                    # @param [Array<ConnectAppInstance>] instance
                    # @param [Hash{String => Object}] headers
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                       @connect_app_instance = payload.body[key].map do |data|
                        ConnectAppInstance.new(version, data)
                       end
                ...
                class ConnectAppPageMetadata < PageMetadata
                    attr_reader :connect_app_page
                    ...
                    def each
                        @connect_app_page.each do |record|
                          yield record
                        end
                    end
                ...
                class ConnectAppListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @connect_app = data_list.map do |data|
                        ConnectAppInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

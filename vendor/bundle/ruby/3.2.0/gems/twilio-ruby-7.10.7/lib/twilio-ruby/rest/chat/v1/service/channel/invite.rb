        ...
        class Chat < ChatBase
            class V1 < Version
                ...
                class ChannelContext < InstanceContext
                    ...
                    # @param [String] role_sid The SID of the [Role](https://www.twilio.com/docs/api/chat/rest/roles) assigned to the new member.
                ...
                class InviteContext < InstanceContext
                    ...
                    # @param [Version] version Version that contains the resource
                    # @param [String] service_sid The SID of the [Service](https://www.twilio.com/docs/api/chat/rest/services) to fetch the resource from.
                    # @param [String] channel_sid The SID of the [Channel](https://www.twilio.com/docs/api/chat/rest/channels) the resource to fetch belongs to.
                ...
                class InviteInstance < InstanceResource
                    ...
                    ##
                    # @return [String] The SID of the [Account](https://www.twilio.com/docs/api/rest/account) that created the Invite resource.
                    def account_sid
                    ...
                    ##
                    # @return [String] The SID of the [Role](https://www.twilio.com/docs/api/chat/rest/roles) assigned to the resource.
                    def role_sid
                        @properties['role_sid']
                    end

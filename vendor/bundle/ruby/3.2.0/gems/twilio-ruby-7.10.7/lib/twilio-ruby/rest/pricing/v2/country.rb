        ...
        class Pricing < PricingBase
            class V2 < Version
                ...
                class CountryInstance < InstanceResource
                    ...
                    ##
                    # @return [Array<PricingV2TrunkingCountryInstanceTerminatingPrefixPrices>] The list of [TerminatingPrefixPrice](https://www.twilio.com/docs/voice/pricing#outbound-prefix-price-with-origin) records.
                    def terminating_prefix_prices
                        @properties['terminating_prefix_prices']
                    end
                    
                    ##
                    # @return [Array<PricingV2TrunkingCountryInstanceOriginatingCallPrices>] The list of [OriginatingCallPrice](https://www.twilio.com/docs/voice/pricing#inbound-call-price) records.

        ...
        class Verify < VerifyBase
            class V2 < Version
                class ServiceContext < InstanceContext
                    ...
                    def create_with_metadata(
                      ...
                      ttl: :unset
                        ...
                        AccessTokenInstanceMetadata.new(
                            @version,
                ...
                class AccessTokenContext < InstanceContext
                    ...
                    ##
                    # Fetch the AccessTokenInstanceMetadata
                    # @return [AccessTokenInstance] Fetched AccessTokenInstance
                ...
                class AccessTokenInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new AccessTokenInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}AccessTokenInstance] access_token_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [AccessTokenInstanceMetadata] The initialized instance with metadata.
                    def initialize(version, access_token_instance, headers, status_code)
                        super(version, headers, status_code)
                        @access_token_instance = access_token_instance
                    end
                    ...
                    def to_s
                      "<Twilio.Api.V2010.AccessTokenInstanceMetadata status=#{@status_code}>"
                    end
                end
                ...
                class AccessTokenListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key)
                       @access_token_instance = payload.body[key].map do |data|

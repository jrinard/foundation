        ...
        class Insights < InsightsBase
            class V1 < Version
                class ConferenceContext < InstanceContext
                    ...
                    ##
                    # Lists ConferenceParticipantPageMetadata records from the API as a list.
                      # @param [String] participant_sid The unique SID identifier of the Participant.
                      # @param [String] label User-specified label for a participant.
                      # @param [String] events Conference events generated by application or participant activity; e.g. `hold`, `mute`, etc.
                    # @param [Integer] limit Upper limit for the number of records to return. stream()
                    ...
                    #    efficient page size, i.e. min(limit, 1000)
                    # @return [Array] Array of up to limit results
                    def list_with_metadata(participant_sid: :unset, label: :unset, events: :unset, limit: nil, page_size: nil)
                        limits = @version.read_limits(limit, page_size)
                ...
                class ConferenceParticipantInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new ConferenceParticipantInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}ConferenceParticipantInstance] conference_participant_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [ConferenceParticipantInstanceMetadata] The initialized instance with metadata.
                ...
                class ConferenceParticipantListResponse < InstanceListResource
                    # @param [Array<ConferenceParticipantInstance>] instance
                ...
                class ConferenceParticipantPageMetadata < PageMetadata
                    attr_reader :conference_participant_page
                ...
                class ConferenceParticipantListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key, limit = :unset)
                      ...
                      @conference_participant = data_list.map do |data|
                        ConferenceParticipantInstance.new(version, data)
                      end
                      @headers = payload.headers
                      @status_code = payload.status_code

        ...
        class Api < ApiBase
            class V2010 < Version
                ...
                class CallContext < InstanceContext
                    ...
                    ##
                    # Create the SiprecInstanceMetadata
                    # @param [String] name The user-specified name of this Siprec, if one was given when the Siprec was created. This may be used to stop the Siprec.
                    # @param [String] connector_name Unique name used when configuring the connector via Marketplace Add-on.
                    # @param [Track] track 
                    # @param [String] status_callback Absolute URL of the status callback.
                    ...
                    def create_with_metadata(
                      ...
                      parameter99_value: :unset
                        ...
                        siprec_instance = SiprecInstance.new(
                            @version,
                            response.body,
                            account_sid: @solution[:account_sid],
                            call_sid: @solution[:call_sid],
                        )
                        SiprecInstanceMetadata.new(
                            @version,
                            siprec_instance,
                            response.headers,
                ...
                class SiprecContext < InstanceContext
                    ...
                    # @param [Version] version Version that contains the resource
                    # @param [String] account_sid The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created this Siprec resource.
                    # @param [String] call_sid The SID of the [Call](https://www.twilio.com/docs/voice/api/call-resource) the Siprec resource is associated with.
                    # @param [String] sid The SID of the Siprec resource, or the `name` used when creating the resource
                    # @return [SiprecContext] SiprecContext
                    def initialize(version, account_sid, call_sid, sid)
                        ...
                        @uri = "/Accounts/#{@solution[:account_sid]}/Calls/#{@solution[:call_sid]}/Siprec/#{@solution[:sid]}.json"
                    ...
                    ##
                    # Update the SiprecInstanceMetadata
                    # @param [UpdateStatus] status 
                    # @return [SiprecInstance] Updated SiprecInstance
                ...
                class SiprecInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new SiprecInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}SiprecInstance] siprec_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [SiprecInstanceMetadata] The initialized instance with metadata.
                    def initialize(version, siprec_instance, headers, status_code)
                        super(version, headers, status_code)
                        @siprec_instance = siprec_instance
                    end
                    ...
                    def to_s
                      "<Twilio.Api.V2010.SiprecInstanceMetadata status=#{@status_code}>"
                    end
                end
                ...
                class SiprecListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key)
                       @siprec_instance = payload.body[key].map do |data|
                ...
                class SiprecPage < Page
                    ...
                    # @return [SiprecInstance] SiprecInstance
                    def get_instance(payload)
                        SiprecInstance.new(@version, payload, account_sid: @solution[:account_sid], call_sid: @solution[:call_sid])
                    end

                    ##
                    # Provide a user friendly representation
                    def to_s
                        '<Twilio.Api.V2010.SiprecPage>'
                    end
                end
                ...
                class SiprecInstance < InstanceResource
                    ...
                    #   {Account}[https://www.twilio.com/docs/iam/api/account] that created this Siprec
                    #   resource.
                    ...
                    # @return [SiprecContext] CallContext for this CallInstance
                    def context
                        unless @instance_context
                            @instance_context = SiprecContext.new(@version , @params['account_sid'], @params['call_sid'], @params['sid'])
                        end
                        @instance_context
                    end
                    
                    ##
                    # @return [String] The SID of the Siprec resource.
                    def sid
                        @properties['sid']
                    end
                    
                    ##
                    # @return [String] The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created this Siprec resource.
                    def account_sid
                        @properties['account_sid']
                    end
                    
                    ##
                    # @return [String] The SID of the [Call](https://www.twilio.com/docs/voice/api/call-resource) the Siprec resource is associated with.
                    def call_sid
                        @properties['call_sid']
                    end
                    
                    ##
                    # @return [String] The user-specified name of this Siprec, if one was given when the Siprec was created. This may be used to stop the Siprec.
                    def name
                        @properties['name']
                    end

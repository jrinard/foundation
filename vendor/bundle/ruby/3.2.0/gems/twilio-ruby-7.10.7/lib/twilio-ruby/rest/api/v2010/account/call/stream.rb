        ...
        class Api < ApiBase
            class V2010 < Version
                ...
                class CallContext < InstanceContext
                    ...
                    ##
                    # Create the StreamInstanceMetadata
                    # @param [String] url Relative or absolute URL where WebSocket connection will be established.
                    # @param [String] name The user-specified name of this Stream, if one was given when the Stream was created. This can be used to stop the Stream.
                    # @param [Track] track 
                    # @param [String] status_callback Absolute URL to which Twilio sends status callback HTTP requests.
                ...
                class StreamInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new StreamInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}StreamInstance] stream_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [StreamInstanceMetadata] The initialized instance with metadata.
                    def initialize(version, stream_instance, headers, status_code)
                    ...
                    def to_s
                      "<Twilio.Api.V2010.StreamInstanceMetadata status=#{@status_code}>"
                    end
                end
                ...
                class StreamListResponse < InstanceListResource
                    ...
                    def initialize(version, payload, key)
                       @stream_instance = payload.body[key].map do |data|

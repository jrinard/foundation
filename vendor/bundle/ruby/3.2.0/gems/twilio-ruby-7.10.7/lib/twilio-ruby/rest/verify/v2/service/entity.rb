        ...
        class Verify < VerifyBase
            class V2 < Version
                class ServiceContext < InstanceContext
                    ...
                    ##
                    # Create the EntityInstanceMetadata
                    # @param [String] identity The unique external identifier for the Entity of the Service. This identifier should be immutable, not PII, length between 8 and 64 characters, and generated by your external system, such as your user's UUID, GUID, or SID. It can only contain dash (-) separated alphanumeric characters.
                    # @return [EntityInstance] Created EntityInstance
                    ...
                    ##
                    # Lists EntityPageMetadata records from the API as a list.
                    # @param [Integer] limit Upper limit for the number of records to return. stream()
                    #    guarantees to never return more than limit.  Default is no limit
                    # @param [Integer] page_size Number of records to fetch per request, when
                    #    not set will use the default value of 50 records.  If no page_size is defined
                    ...
                    def list_with_metadata(limit: nil, page_size: nil)
                        ...
                        EntityPageMetadata.new(@version, response, @solution, limits[:limit])
                    end
                ...
                class EntityInstanceMetadata <  InstanceResourceMetadata
                    ##
                    # Initializes a new EntityInstanceMetadata.
                    # @param [Version] version Version that contains the resource
                    # @param [}EntityInstance] entity_instance The instance associated with the metadata.
                    # @param [Hash] headers Header object with response headers.
                    # @param [Integer] status_code The HTTP status code of the response.
                    # @return [EntityInstanceMetadata] The initialized instance with metadata.
                ...
                class EntityListResponse < InstanceListResource
                    # @param [Array<EntityInstance>] instance
                    # @param [Hash{String => Object}] headers
                    # @param [Integer] status_code
                    def initialize(version, payload, key)
                       @entity_instance = payload.body[key].map do |data|
                        EntityInstance.new(version, data)
                       end
                ...
                class EntityPageMetadata < PageMetadata
                    attr_reader :entity_page

        ...
        class Conversations < ConversationsBase
            class V1 < Version
                class CredentialList < ListResource
                    ...
                    # @param [String] api_key [GCM only] The API key for the project that was obtained from the Google Developer console for your GCM Service application credential.
                ...
                class CredentialInstance < InstanceResource
                    ...
                    ##
                    # @return [String] The unique ID of the [Account](https://www.twilio.com/docs/iam/api/account) responsible for this credential.
                    def account_sid
                        @properties['account_sid']
                    end
                    
                    ##
                    # @return [String] The human-readable name of this credential, limited to 64 characters. Optional.
                    def friendly_name
                    ...
                    ##
                    # @return [String] An absolute API resource URL for this credential.
                    def url
                        @properties['url']
                    end
